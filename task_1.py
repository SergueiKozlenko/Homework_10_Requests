...
def get_superheros_intelligence(superhero_name):
    """Примет имя супергероя, сделает http запрос и возвратит словарь,
    где значением будет его intelligence."""
...
def print_max_superheros(superheros_dict):
    """Примет словарь супергероев и выведет на экран самых умных."""
